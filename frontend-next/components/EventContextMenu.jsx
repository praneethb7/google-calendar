...
export default function EventContextMenu({ event, x, y, onClose, onEdit }) {
  ...
  return (
    <>
      ...
      <div ref={ref} style={style} className="z-[1000] bg-white dark:bg-[#2d2e2f] rounded-xl shadow-[0_4px_16px_rgba(0,0,0,0.24)] border border-gray-200 dark:border-[#444746] py-1.5 w-[210px] animate-fadeIn">
        {/* Edit */}
        <button
        ...
        <div className="border-t border-gray-200 dark:border-[#444746] my-1" />
          ...
          {COLORS.map((c) => (
            <button
              ...
              className={`w-6 h-6 rounded-full transition-transform hover:scale-110 ${
                event.color === c.value ? "ring-2 ring-offset-1 ring-gray-800 dark:ring-white dark:ring-offset-[#2d2e2f]" : ""
              }`}
